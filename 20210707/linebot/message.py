...
def R():
    try:
        ...
        rqt = rq.get('https://raw.githubusercontent.com/abel108714/test/master/stock.jpg')
        if rqt.status_code == 200:
            message = ImageSendMessage(
                original_content_url="https://raw.githubusercontent.com/abel108714/test/master/stock.jpg",
                preview_image_url="https://raw.githubusercontent.com/abel108714/test/master/stock.jpg"
            )
            return message
        else:
            message=TextSendMessage(text="")
