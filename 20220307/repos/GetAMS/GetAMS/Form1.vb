...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SetCursorPos(NewPt2.getPosX(572), NewPt2.getPosY(390)) '點下拉箭頭位置
        setMouseClick("left", 2)
        'SetCursorPos(NewPt2.getPosX(NewPt.getPosX(460)), NewPt2.getPosY(NewPt.getPosY(443 - 17))) '460,443 左欄第一列  改第二
        'setMouseClick("left", 2)
        ...
        setMouseClick("left", 2)
        '---------------------------------------------------------------------------
        'SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443)) '460,443 左欄第一列  改第二
        'setMouseClick("left", 2)
        ...
        ''---------------------------------------------------------------------------
        'SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443 + 17)) '460,443 左欄第二列  改第三
        'setMouseClick("left", 2)
        'SetCursorPos(NewPt.getPosX(578), NewPt.getPosY(443)) '578, 443 右欄第二列
        'setMouseClick("left", 2)
        ''---------------------------------------------------------------------------
        ...
        'SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(460 + 17)) '460,460 左欄第三列  改第四
        'setMouseClick("left", 2)
        '''578,443
