...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        file_dir = "S:\網通部\◎資訊\data\績效資料\Book1.xlsm"
        ...
        report_path = "C:\Program Files (x86)\Apache Software Foundation\Apache2.2\htdocs\"


        'xlBook = xlApp_sou.Workbooks.Open(file_dir2) '打開報表巨集
        xlBook = xlApp_sou.Workbooks.Open(file_dir) '打開報表巨集

        xlsheet.Activate '啟動第一頁工作表

        xlApp_sou.Run("'Book1.xlsm'!SD.各業務銷貨明細")
        ...
        '承諾目標C截圖
        '承諾目標D截圖
        xlApp_sou.Run("'Book1.xlsm'!ST.各業務銷貨明細")
        xlApp_sou.Run("'Book1.xlsm'!ST.各業務銷貨明細")
        setScreenPic(report_path, report1, 23, 194, 0, 0, 740, 430)
