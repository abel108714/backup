...
#schedule.every().monday.at("15:00").do(job2) 
#schedule.every().tuesday.at("15:00").do(job2) 
#schedule.every().wednesday.at("15:00").do(job2) 
#schedule.every().thursday.at("15:00").do(job2) 
#schedule.every().friday.at("15:56").do(job) 
