    ...
    if ('[庫存查詢]' in msg or '[庫存及效期]' in msg ) and (user_id == admin_user_id or user_id == salesman_id):
        ...
        if len(DataArrOfINVDB01002)==0:
            ...
            for i in range(len(DataArr)):
                ...
                # print("品號 : "+str(DataArr[i][0]))
                # print("品名 : "+str(DataArr[i][1]))
                print(" : "+str(DataArr[i][0]))
                print(" : "+str(DataArr[i][1]))
                print(" : "+str(DataArr[i][2]))
                print(" : "+str(DataArr[i][3]))
                print(" : "+str(DataArr[i][4]))
                print(" : "+str(DataArr[i][5]))
                print(" : "+str(DataArr[i][6]))
                print(" : "+str(DataArr[i][7]))
                print(" : "+str(DataArr[i][8]))
                # if a.isDate(str(DataArr[i][5])):
