            ...
            try:
                sql="insert sq(\
                    ...
                    values('\
                        ...
                        factory_code)+"','"+str(library_code)+"','"+str(group_name)+"','"+str(customer_name)+"','"+str(gift_spare_quantity)+"'\
                ...
                sql="update sq set \
                        ...
                        factory_code = '"+str(factory_code)+"',library_code = '"+str(library_code)+"',group_name = '"+str(group_name)+"',customer_name = '"+str(customer_name)+"',gift_spare_quantity = '"+str(gift_spare_quantity)+"'\
                     \
...
def main(argv):
    ...
    for k in range(1,res+1):
        for j in range(6,max_row+1):
            ...
            # print(isSubstringExist(str(RowData[1]),"銷貨小計")==False and isSubstringExist(str(RowData[1]),"退貨小計")==False)  
                ...
                if isSubstringExist(str(RowData[1]),"銷貨小計")==False and isSubstringExist(str(RowData[1]),"退貨小計")==False:
                    ...
                    if str(RowData[21]) == "南港區農會" :#and str(RowData[1]) == "11304007":
                        print("RowData[2]客戶代號="+str(RowData[2]))
                        time.sleep(2)
        ...
        # factory_code)+"','"+str(library_code)+"'\
                    ...
                    insertSqData(RowData[0],RowData[1],RowData[2],RowData[3],RowData[4],RowData[5],RowData[6],RowData[7],RowData[11],RowData[12],RowData[13],RowData[14],RowData[15],RowData[16],RowData[17],RowData[18],RowData[19],RowData[20],str(group),RowData[21],RowData[22])
