...
Public Class Form1
    ...
    Public Sub Form_load() Handles Me.Load
        'ProgressBarFrom.setInrNum(100000)
        ...
        Else
            'MsgBox("檔案不存在")
        End If
        'Button2_Click(Button2, New System.EventArgs()) '自動按下按鈕
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        'Dim thisDate1 As Date = DateTime.Now.AddDays(-1) '#2020/04/08# 前一天
        ...
        '& "_N每日業績N.xls"
        dataPath = dataPath & "\" & "COPR38" & thisDate1.ToString("yyyyMMdd") & "*.xlsx"
        'COPR38 & 20200525 & 000006 & 20200525 & 0001
        ...
        Try
            ...
            If Dir(progPath) = "" Then '判斷EXCEL是否打開
                ...
                Try
                    ...
                    'MsgBox(root)
                    'MsgBox("COPR38" & thisDate1.ToString("yyyyMMdd"))
                    Dim i As Integer = 1
                    Dim dirs As String() = Nothing
                    Dim file_count As Integer = 0
                    'Dim search_file_name As String
                    Dim file_name1 As String = "", file_name2 As String = ""
                    Dim file_dir1 As String = "", file_dir2 As String = ""
                    'Dim foundFile As String
                    'MsgBox(Val(8))
                    'MsgBox(Abs(Val(8)))
                    'MsgBox("s")

                    'ProgressBarFrom.Show()
                    'ProgressBarFrom.setInrNum(100000)
                    'For i = 1 To 100000
                    'ProgressBarFrom.setBarValue(i)
                    'search_file_name = "COPR38" & thisDate1.ToString("yyyyMMdd") & "*" & thisDate1.ToString("yyyyMMdd") & "*.xlsx"
                    'search_file_name = "COPR38" & thisDate1.ToString("yyyyMMdd") & CStr(getiStr(i)) & thisDate1.ToString("yyyyMMdd") & "*.xlsx"
                    'dirs = Directory.GetFiles(root, "COPR38" & thisDate1.ToString("yyyyMMdd") & CStr(getiStr(i)) & thisDate1.ToString("yyyyMMdd") & "*.xlsx")
                    ...
                    'Next
                    'If ProgressBarFrom.getBarValue = 100 Then
                    'ProgressBarFrom.Close()
                    'End If
                    'dirs = Directory.GetFiles(root, "COPR38" & thisDate1.ToString("yyyyMMdd") & "000006" & thisDate1.ToString("yyyyMMdd") & "*.xlsx")
                    'dirs = Directory.GetFiles(root, "COPR3820200525000006202005250001.xlsx")
                    'MsgBox(789)
                    'COPR38 & 20200525 & 000006 & 20200525 & 0001
                    ...
                    If dirs IsNot Nothing Then
                        'Dim ProgressBarFrom As New Form4
                        'ProgressBarFrom.Show()
                        'ProgressBarFrom.closeBar()
                        'MsgBox(2)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        ...
                        xlBook = Nothing
                        'ProgressBarFrom.addBarValue(1)
                        'If FileOpened(file_name1) = False Then
                        xlBook = xlApp_sou.Workbooks.Open(file_dir1) '打開EXCEL工作簿
                        'ProgressBarFrom.addBarValue(1)
                        'End If
                        'If FileOpened(file_name2) = False Then
                        xlBook = xlApp_sou.Workbooks.Open(file_dir2) '打開EXCEL工作簿
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(1)
                        'ProgressBarFrom.addBarValue(60)
                        'End If
                        ...
                        'ProgressBarFrom.addBarValue(1)
                        xlApp_sou.Run("'Book1.xlsm'!部門業績表")

                        'ProgressBarFrom.addBarValue(100)

                        xlApp_sou.Run("'Book1.xlsm'!開發部門業績表")
                    ...
                    Else
                        ...
                        MsgBox("無業績表資料無法產生業績表，請先產生所需鼎新業績報表，每日業績及累積業績")
                        Me.Close()
                        ...
                        OpenFileDialog1.FileName = "COPR38" & thisDate1.ToString("yyyyMMdd")
                        OpenFileDialog1.Filter = "*|*.xlsx" '2020-04-08-08-40-09_N每日業績N.xls"
                        'COPR38 & 20200525 & 000006 & 20200525 & 0001
                            ...
                            If String.Compare(str(0), "autoHideWin") = 0 Then
                                ...
                                If autohidewin = "True" Then
                                    ...
                                    Try
                                        ...
                                        'Form1.Show()
                                        'Me.Visible = False
                                        hwd1 = FindWindow(vbNullString, "產生部門業績表小工具")
                                        'Me.Visible = False
                                        'System.Windows.Forms.Application.DoEvents()
                                        'Me.Refresh()
                                        If hwd1.Equals(IntPtr.Zero) Then
        ...
        Try
            If Dir(progPath) = "" Then '判斷EXCEL是否打開
                ...
                Try
                    ...
                    For Each dir In dirs
                        If (File.Exists(dir)) Then
                            ...
                            If file_count = 1 Then
                                ...
                                'file_name1 = search_file_name
                                file_name1 = Path.GetFileName(dir)
                                'File.SetCreationTime(file_name1, DateTime.Now)

                                Dim dt As DateTime = File.GetCreationTime(dir)
                                'MsgBox("dt: " & dt)
                                Dim dt2 As DateTime = File.GetLastWriteTime(dir)
                                'MsgBox("dt2: " & dt2)
                                'MsgBox("i=" & i)
                                'MsgBox("file_name1:" & file_name1)
                                Dim temp_data1 As String = file_name1
                    ...
                    'If File.Exists(dir) And dirs.Length = 1 Then
                    'MsgBox(1)
                    'ProgressBarFrom.setBarValueFull()
                    ...
                    If dirs IsNot Nothing Then
                        ...
                        'xlApp_sou.Run("'Book1.xlsm'!網通部門業績表")
                        xlApp_sou.Run("'Book1.xlsm'!網通目標達成比")
    ...
    Private Sub 部門人員資料設定ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 資料設定ToolStripMenuItem.Click
        Dim inputFrom As New Form3
        inputFrom.Show()
        'Me.Dispose(False)
    End Sub

    Public Function getiStr(i)
        Dim j As Integer = 0
        Dim i_str As String
