...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        file_dir = "S:\網通部\◎資訊\目標達成比\實體通路\" + NowDate.ToString("yyyyMMdd") + "實體通路目標達成比.xlsm"
        ...
        report = NowDate.ToString("yyyyMMdd") + "實體通路目標達成比"
        'report_path = "S:\網通部\◎資訊\"
        'S:\網通部\◎資訊\目標達成比\實體通路
        ...
        'setScreenPic(github_report_path, report, 20, 193, 0, 0, 999, 612) '23,196,0,0,1225,697網通報表多一列

        'setScreenPic(report_path, report, 15, 192, 0, 0, 1224, 330)
        'setScreenPic(github_report_path, report, 15, 192, 0, 0, 1224, 330)
        '20,192,0,0,1229,391
        'setScreenPic(report_path, report, 20, 192, 0, 0, 1229, 391)
        'setScreenPic(github_report_path, report, 20, 192, 0, 0, 1229, 391)

        setScreenPic(report_path, report, 15, 191, 0, 0, 1239, 361)
        setScreenPic(github_report_path, report, 15, 191, 0, 0, 1239, 361)
