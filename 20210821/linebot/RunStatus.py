...
class RunStatus:
    ...
    def addRunStatusCount(self, AddValue):
        self.RunStatusCount=self.RunStatusCount+AddValue

    def setRunStatusCount(self,RunStatusCount):
        self.RunStatusCount=RunStatusCount

    def getRunStatusCount(self):
        return self.RunStatusCount

    def showRunStatus(self):
        if self.RunStatusCount==0:
            self.RunStatus="--"
        elif self.RunStatusCount==1:
            self.RunStatus="\\"
        elif self.RunStatusCount==2:
            self.RunStatus="|"
        elif self.RunStatusCount==3:
            self.RunStatus="/"
        
        if self.RunStatusCount==3:
            self.RunStatusCount=0
        # else:
        #     self.RunStatusCount=self.RunStatusCount+1
        return self.RunStatus

    # def showTerminal(self,str):輸出到Python視窗
