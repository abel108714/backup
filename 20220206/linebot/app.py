...
def isHoliday():
    ...
    d_str = c.getMonth()+ "/"+ c.getDay()#c.getYear()+ "/"+
    # d_str="2/10"
    s=["01/01","02/01","02/02","02/03","02/04","02/10","02/11","02/12","02/15","02/16","03/01","04/02","04/05","04/30","06/14","09/20","09/21","10/11","12/31"]
    for s_str in s:
        print(d_str)
        print(s_str)
        if d_str ==s_str:
...
def job2():
    ...
    if date.strftime("%H:%M") == "16:18":#"17:55":#自動發網通報表
