...
Public Class Form1
	...
	ReadOnly fileReader As String = My.Computer.FileSystem.ReadAllText("C:\Users\udev77\Desktop\test.txt")
	...
	Private ReadOnly value4 As String
	Dim cmd As String
	Dim mySqlSysTime As String
	...
	Public Sub getData()
		...
		GetMySqlConn()
		'Dim str1 As String = "Select UID AS 員工編號,Dept AS 部門,Name AS 業務員,Target AS 業績目標 from members;"
		Dim str1 As String = "Select Dept AS 部門,Name AS 業務員 from members;"
	...
	Public Sub DataGridView1_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellClick
		...
		DataGridView1.Columns("業務員").ReadOnly = True
...
Chr(34) & " WHERE UID = " & TextBox1.Text & ";"
			...
			sqlconn.Close()
		Catch ex As Exception
			MsgBox("Error occured: Could not insert record", "Error 07")
		End Try
		getData()
	...
	Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
		...
		If DataGridView1.CurrentRow.Index <> Nothing Then '取得目前所選資料列不為空
			'posX = DataGridView1.CurrentRow.Index '取得目前所選資料列
	...
	Private Sub 技術支援ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 技術支援ToolStripMenuItem.Click
		MessageBox.Show("如有問題，請恰技術人員。", "技術支援")
	End Sub

	Private Sub 關於ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 關於ToolStripMenuItem.Click
		MessageBox.Show("業務人員業績目標管理系統 版本0.1", "關於")
	End Sub

	Private Sub 登入ToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles 登入ToolStripMenuItem.Click
		InputBox("帳號", "密碼", "登入")
	End Sub
