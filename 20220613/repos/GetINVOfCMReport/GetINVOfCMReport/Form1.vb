...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Dim startCommand As String = "myapp.exe"
        'Dim startArgu As String = "myapp.ini"
        'Dim myAppProcess As Process = Process.Start(startCommand, startArgu)
        'AppActivate(myAppProcess.Id)
        ...
        'hwd1 = FindWindow(vbNullString, "作業進度顯示")
        'MsgBox(hwd1)
        '取得目前系統中前景程式的視窗(Handle)
        'nowhwd = GetForegroundWindow()
        'MsgBox(nowhwd)
        ...
        'SetForegroundWindow(hwd)
        'End If
        'AppActivate("Leader作業元件中心")
        SetCursorPos(639, 512) '1125.101
        setMouseClick("left", 2) '
        ...
        For Each a As Process In Process.GetProcesses
            ...
            If a.ProcessName = "LeaderWorkCenter" Then
                a.Kill()
            End If
            If a.ProcessName = "QueueManagerC" Then
                a.Kill()
            End If
            If a.ProcessName = "MainMenu" Then
                a.Kill()
            End If
...
Public Class ScrnPt
    ...
    Public Function getNewCtrX()
        'Me.NewSpecX = Me.NewCtrX - (Me.OrigCtrX - OrigSpecX)
        Me.NewCtrX = Me.NewSpecX + (Me.OrigCtrX - OrigSpecX)
        Return Me.NewCtrX
    End Function

    Public Function getNewCtrY()
        'Me.NewSpecY = Me.NewCtrY - (Me.OrigCtrY - OrigSpecY)
