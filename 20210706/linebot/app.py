...
def job2():
    ...
    elif date.strftime("%H:%M") == "15:24":# and group_id == "Cb7d45ef695c158c777ced6547bbd2e63":#自動發門市報表
        print('case stock')
        line_bot_api.push_message(
...
def handle_message(event):#
    ...
    if '[進價與促銷]' in msg  and (user_id == admin_user_id or user_id == salesman_id):
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text=str('陸續新增中')))
