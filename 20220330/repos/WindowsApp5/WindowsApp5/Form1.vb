...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        file_dir = "C:\Users\udev77\Desktop\門市部產出報表\門市部日報表_巨集20220315版.xls"
        ...
        'xlApp_sou.Run("'Book1.xlsm'!ST.調整報表符合至螢幕大小1")
        ...
        'xlApp_sou.Run("'Book1.xlsm'!ST.調整報表符合至螢幕大小2")
        ...
        '承諾目標C截圖
        '承諾目標D截圖
        xlApp_sou.Run("'Book1.xlsm'!ST.門市部日報表截圖")
        ...
        xlApp_sou.Run("'Book1.xlsm'!ST.承諾目標")
        xlApp_sou.Run("'Book1.xlsm'!ST.門市累積業績截圖")
        ...
        xlApp_sou.Run("'Book1.xlsm'!ST.承諾目標A截圖")
        ...
        xlApp_sou.Run("'Book1.xlsm'!ST.承諾目標B截圖")
        ...
        xlApp_sou.Run("'Book1.xlsm'!ST.承諾目標C截圖")
        ...
        xlApp_sou.Run("'Book1.xlsm'!ST.承諾目標D截圖")
