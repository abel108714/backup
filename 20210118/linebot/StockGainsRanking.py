...
def getRelatedWarrants(StockNO):
   ...
   # related_warrants=driver.find_elements_by_xpath("/html/body/center/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td")
   related_warrants=driver.find_element_by_class_name("yui_stock_warrant")
      ...
      if i>1 and float(s) > 8.5:#首行不印，漲幅大於8.5%
         ...
         if fda.getData(2,Data[1]) != None:
            if fda.getData(2,Data[1]) == None and dt.getDiffDate(fda.getData(2,Data[1]),ToDayStr)!=0:
               ...
               print(Data[0] + "\t" + Data[1] + "\t" + Data[2] +  "\t\t" + Data[5] + "\t\t" + getRelatedWarrants(Data[1]))
