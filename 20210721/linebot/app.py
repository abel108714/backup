...
from PPAndProm import getDataArrOfPPAndProm
...
newDataAccess=FileDataAccess(0,'3','-','S:\\網通部\\網通部每月預入績效.txt')
updateArr=[]
def isWorkday():
    c=d.Date()
    print(c.getDay())
...
def handle_message(event):#
    ...
    # dict['id'] = ["U8ec81edfb39499a39625be8c3e335ce0","U3c77f40434fa99e97e2f6e9cfb6ff0f6","U4516a5c0c8ee5368ad79385a28482cfd"]
    # admin_user_id="Uee6224531167e863e3c08504055d6ed2"
    dict['id'] = ["U8ec81edfb39499a39625be8c3e335ce0","U3c77f40434fa99e97e2f6e9cfb6ff0f6","U4516a5c0c8ee5368ad79385a28482cfd","Uee6224531167e863e3c08504055d6ed2"]
    admin_user_id="123"
