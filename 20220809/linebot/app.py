...
def job2():
    ...
    if date.strftime("%H:%M") == "17:00":#"17:55":#自動發樣品單
        print("自動發樣品單")
        try:

            #U1b14e7c863a29b5960138da88f7c02b8  #李永齊
            #U70849fb74ae0d474e52feb96c12ee31d  #陳巧芬
            #U6df2ce1fcbd41372eec173b3f869df9f  #駱麗玲
            #U7a8e507cdeb7304da1963ecdb6b43506  #黃三和
            #U45269b35f85175b922c5ba904e2e2644  #林渝涔
            #測試用
            #line_bot_api.push_message("U3c77f40434fa99e97e2f6e9cfb6ff0f6", SAReport('U1b14e7c863a29b5960138da88f7c02b8'))#陳永宗
            line_bot_api.push_message("Uee6224531167e863e3c08504055d6ed2", SAReport("S:\開發部\◆業績資料\★開發部績效小幫手專用★\樣品單.txt"))#周立修
    ...
    elif date.strftime("%H:%M") == "16:40":#銷貨明細
        try:
            #U1b14e7c863a29b5960138da88f7c02b8  #李永齊
            #U70849fb74ae0d474e52feb96c12ee31d  #陳巧芬
            #U6df2ce1fcbd41372eec173b3f869df9f  #駱麗玲
            ...
            #測試用
            #line_bot_api.push_message("U3c77f40434fa99e97e2f6e9cfb6ff0f6", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#陳永宗
            #line_bot_api.push_message("U4516a5c0c8ee5368ad79385a28482cfd", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#吳佳容
            line_bot_api.push_message("Uee6224531167e863e3c08504055d6ed2", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#周立修


            #正式用
            line_bot_api.push_message("U1b14e7c863a29b5960138da88f7c02b8", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#李永齊
            line_bot_api.push_message("U70849fb74ae0d474e52feb96c12ee31d", SDReport('U70849fb74ae0d474e52feb96c12ee31d'))#陳巧芬
            line_bot_api.push_message("U6df2ce1fcbd41372eec173b3f869df9f", SDReport('U6df2ce1fcbd41372eec173b3f869df9f'))#駱麗玲
            line_bot_api.push_message("U7a8e507cdeb7304da1963ecdb6b43506", SDReport('U7a8e507cdeb7304da1963ecdb6b43506'))#黃三和
            line_bot_api.push_message("U45269b35f85175b922c5ba904e2e2644", SDReport('U45269b35f85175b922c5ba904e2e2644'))#林渝涔
        except Exception as e:
            print("linebot無回應: "+str(e))
        closeThread()
...
def handle_message(event):#
    ...
    if keymsg_matches:
        ...
        if matches:#訊息
            ...
            if date_matches:#日期
                date_match = date_matches.group()
                #print(date_match)
                month_match = date_match.split('/')[0].strip()
                print('month_match:' + date_match.split('/')[0].strip())
                day_match = date_match.split('/')[1].strip()
                print('day_match:' + date_match.split('/')[1].strip())
            else:
                print('date_matches: 格式不符')
            amount_regex = r"[0-9]+[,]?[0-9]+[,]?[0-9]+[,]?[0-9]+"
            amount_matches = re.search(amount_regex, expected_perf_str)
            ...
            newDate=d.Date()
            # print("天="+newDate.getDay())
            # print("月="+newDate.getMonth())
            # print("month_match="+month_match)
            # print("str(int(newDate.getMonth()))="+str(int(newDate.getMonth())))
            if int(newDate.getMonth()) == int(month_match):#更新的是本月   
                print("全聯本月預入績效已紀錄")
                newDataAccess=FileDataAccess(0,'3','-','S:\\網通部\★網通部績效小幫手專用★\網通部每月預入績效.txt')
                updateArr=[date_match.split('/')[1].strip(),amount_match]
                ...
                print("全聯預入金額: " + str(PreEntryAmount))
                try:
                    line_bot_api.reply_message(event.reply_token, TextSendMessage(text=str('Ok! 全聯本月預入績效已更新')))
                except Exception as e:
                    print("linebot無回應: "+str(e))
            else:#否則，更新的是下個月
                print("全聯下個月預入績效已紀錄")
    ...
    if '[補發庫存提醒]' in msg and user_id == "Uee6224531167e863e3c08504055d6ed2" :#and user_id == admin_user_id :
        print("--------------[補發庫存提醒]------------")
        ...
        #自己
        try:
            line_bot_api.reply_message(event.reply_token, TextSendMessage(text=str('已補補發庫存提醒')))
        except Exception as e:
            print("linebot無回應: "+str(e))
        closeThread()
    ...
    if '[SD]' in msg :#and user_id == admin_user_id :
        print("[SD]")
        #網通群組
        try:
            #line_bot_api.push_message("Caa547d0a89e353969160556a34444c64", SDReport())
            #line_bot_api.reply_message(event.reply_token, SDReport(user_id))
            #line_bot_api.push_message("U3c77f40434fa99e97e2f6e9cfb6ff0f6", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#陳永宗
            #line_bot_api.push_message("U4516a5c0c8ee5368ad79385a28482cfd", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#吳佳容
            #line_bot_api.push_message("Uee6224531167e863e3c08504055d6ed2", SDReport('U1b14e7c863a29b5960138da88f7c02b8'))#周立修
            #U1b14e7c863a29b5960138da88f7c02b8  #李永齊
            ...
            print("linebot無回應: "+str(e))
        closeThread()
    if '[SA]' in msg :#and user_id == admin_user_id :
        print("[SA]")
        try:
            ...
            #測試用
            #line_bot_api.push_message("U3c77f40434fa99e97e2f6e9cfb6ff0f6", SAReport('U1b14e7c863a29b5960138da88f7c02b8'))#陳永宗
            line_bot_api.push_message("U3c77f40434fa99e97e2f6e9cfb6ff0f6", SAReport("S:\開發部\◆業績資料\★開發部績效小幫手專用★\樣品單.txt"))#陳永宗
            line_bot_api.push_message("Uee6224531167e863e3c08504055d6ed2", SAReport("S:\開發部\◆業績資料\★開發部績效小幫手專用★\樣品單.txt"))#周立修
    ...
    if ('在?' in msg or '在？' in msg or '在嗎' in msg ) and user_id == "Uee6224531167e863e3c08504055d6ed2" :#user_id == admin_user_id :
        # print("在?")
        #自己
        try:
