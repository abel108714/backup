...
from Line import isLineFriendName,insertLineFriendName
...
def handle_message(event):#
    ...
    if msg.isdigit() and (user_id == admin_user_id or user_id == salesman_id):
        ...
        # print(updateArr)
        # newDataAccess.setData(title_match,updateArr)
    elif msg.isdigit() == False and (user_id == admin_user_id or user_id == salesman_id) and (msg != "[庫存查詢]" and msg != "[進價與促銷]" and msg != "[庫存及效期]" and msg != "[run]" and msg !="[補發門市報表]" and msg !="[補發網通報表]" and msg !="[網通報表測試]" and msg !="[下一頁]"):
        print("文字msg")
        print("msg : " + msg)
        print("user_id : " + user_id)
        path='C:\\linebot\\msg\\'
