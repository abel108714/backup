...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'MsgBox("2")
        'hwd1 = FindWindow(vbNullString, "交易明細資訊維護作業")
        'hwd1 = FindWindow(vbNullString, "交易明細資訊維護作業(POSI49)")
        ''hwd1 = FindWindow(vbNullString, "交易明細資訊維護作業")
        ...
        If hwd1 <> nowhwd Then
            ...
            'MsgBox("聚焦2")
        End If
        'Dim p2() As Process = System.Diagnostics.Process.GetProcessesByName("LeaderWorkCenter.exe")
        ''MsgBox("3")
        'hwd1 = p2(0).MainWindowHandle
        ''MsgBox("4")
        'If hwd1 <> nowhwd Then
        '    'MsgBox(hwd1)
        '    SetForegroundWindow(hwd1)
        ...
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(619)), NewPt2.getPosY(NewPt.getPosY(198))) '619, 198 按視窗'619,77(新螢幕)
        ...
        'debug += 1
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(525)), NewPt2.getPosY(NewPt.getPosY(329))) '525,329 按進階設定'617,70(新螢幕)
        'debug += 1
        setMouseClick("left", 2)
        'debug += 1
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(645)), NewPt2.getPosY(NewPt.getPosY(486))) '645,486
        'debug += 1
        setMouseClick("left", 2)
        ...
        Thread.Sleep(10 * 1000)
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(498)), NewPt2.getPosY(NewPt.getPosY(546))) '498,546 按單身
        setMouseClick("left", 2)
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(645)), NewPt2.getPosY(NewPt.getPosY(486))) '645,486
        setMouseClick("left", 2)
        Thread.Sleep(10 * 1000)
        ...
        Thread.Sleep(10 * 1000)
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(504)), NewPt2.getPosY(NewPt.getPosY(742))) '504, 742 按按確定
        setMouseClick("left", 2)
        ...
        '------------------
        Thread.Sleep(10 * 1000)
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(544)), NewPt2.getPosY(NewPt.getPosY(250))) '544, 250 按轉出excel
        setMouseClick("left", 2)

        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(516)), NewPt2.getPosY(NewPt.getPosY(730))) '516,730 按確定
        setMouseClick("left", 2)
        Thread.Sleep(10 * 1000)
        ...
        If File.Exists(SouPath & Convert.ToString("POSI49_1.XLSX")) Then '如果有預購資料
            ...
            xlApp_macro.Run("'Book1.xlsm'!ST.setDataCt") '記錄資料列數寫入到DataCt.txt
            'MsgBox("5")
            'debug += 1
            'xlsheet = xlBook.Worksheets(2) '打開EXCEL第二((POSTB.TB010 = N'11704121') And (POSTB.TB018 = 1750) And (POSTB.TB013 = N'11704121') And (POSTB.TB009 = N'4719349110337')POSTA.TA001 >= N'20210501') And (POSTA.TA001 <= N'20210517')頁工作表
            ...
            If File.Exists(docpath & Convert.ToString("\DataCt.txt")) Then
                ...
                SetCursorPos(NewPt2.getPosX(NewPt.getPosX(305)), NewPt2.getPosY(NewPt.getPosY(356))) '305,356按合計欄位頁籤
                setMouseClick("left", 2)
                Thread.Sleep(2 * 1000)

                SetCursorPos(NewPt2.getPosX(NewPt.getPosX(305)), NewPt2.getPosY(NewPt.getPosY(248))) '305,248回第一筆
                setMouseClick("left", 2)
                Thread.Sleep(2 * 1000)
                ...
                For i As Integer = 2 To DataCt '第二筆以(POSTA.TA001 >= N'20200901') And (POSTA.TA001 <= N'20200910')後需要按下一頁
                    ...
                    SetCursorPos(NewPt2.getPosX(NewPt.getPosX(360)), NewPt2.getPosY(NewPt.getPosY(252))) '360, 252按下一筆
                    setMouseClick("left", 2)
                    Thread.Sleep(2 * 1000)
                    SetCursorPos(NewPt2.getPosX(NewPt.getPosX(544)), NewPt2.getPosY(NewPt.getPosY(250))) '544, 250 按轉出excel
                    setMouseClick("left", 2)
