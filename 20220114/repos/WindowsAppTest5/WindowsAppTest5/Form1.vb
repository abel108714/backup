...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            'MsgBox("12")
        End If
        If (Format(Now, "HH:mm") >= "18:40") Then
            'setMouseClick("left", 2)
            SetCursorPos(NewPt.getPosX(578), NewPt.getPosY(443)) '578, 443 右欄第二列
            setMouseClick("left", 2)
            '---------------------------------------------------------------------------
        ...
        If (Format(Now, "HH:mm") >= "16:00") And (Format(Now, "HH:mm") <= "16:59") Then
            ...
            SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443)) '460,443 左欄第二列  改第三
            setMouseClick("left", 2)
        ...
        Else
            ...
            setMouseClick("left", 2)
            '多按一下跳過門市
            SetCursorPos(572, 390) '點下拉箭頭位置01439
        ...
        If (Format(Now, "HH:mm") >= "16:00") And (Format(Now, "HH:mm") <= "16:59") Then
            SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443 + 17)) '460,460 左欄第三列  改第四
            setMouseClick("left", 2)
        Else
            SetCursorPos(572, 390) '點下拉箭頭位置
            setMouseClick("left", 2)
        ...
        setMouseClick("left", 1)
        If (Format(Now, "HH:mm") >= "16:00") And (Format(Now, "HH:mm") <= "16:59") Then
            SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443 + 17 + 17)) '460,460 左欄第三列  改第四
            setMouseClick("left", 2)
        Else
            SetCursorPos(572, 390) '點下拉箭頭位置
            setMouseClick("left", 2)
        ...
        If (Format(Now, "HH:mm") >= "16:00") And (Format(Now, "HH:mm") <= "16:59") Then
            SetCursorPos(NewPt.getPosX(460), NewPt.getPosY(443 + 17 + 17 + 17)) '460,460 左欄第三列  改第四
            setMouseClick("left", 2)
        Else
            SetCursorPos(572, 390) '點下拉箭頭位置
            setMouseClick("left", 2)
