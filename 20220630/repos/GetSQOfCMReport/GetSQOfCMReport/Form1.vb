...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SetCursorPos(NewPt2.getPosX(NewPt.getPosX(790)), NewPt2.getPosX(NewPt.getPosY(497))) '輸入密碼座標
        ...
        If (Format(Now, "HH:mm") >= "16:00") And (Format(Now, "HH:mm") <= "16:59") Then
            SetCursorPos(NewPt2.getPosX(NewPt.getPosX(460)), NewPt2.getPosY(NewPt.getPosY(443 - 17))) '460,443 左欄第一列
            'MsgBox("1")
        Else
        ...
        setMouseClick("left", 2)
        While get_Color(NewPt2.getPosX(922), NewPt2.getPosY(556)) <> "255.255.255"
            Thread.Sleep(1000)
            If get_Color(NewPt2.getPosX(922), NewPt2.getPosY(556)) = "255.255.255" Then
                Thread.Sleep(1000)
                Exit While
            End If
        End While
        ...
        setSendKeys("{RIGHT}", 5) '按右,不開excel伴　
        setSendEnter(0) '
    ...
    Public Sub setPerfReport(EarMonDate As String, NowDate As String, hwd1 As IntPtr, WaitingSec As Integer)
        ...
        setSendEnter(2)
        SetCursorPos(480, 369) '480,369 存成excel01439
        setMouseClick("left", 0)
        setSendEnter(1) '按enter
        setSendKeys("{RIGHT}", 1) '按右,不開excel
        setSendEnter(0) '
