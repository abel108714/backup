...
class FileDataAccess:
    ...
    def __init__(self,key=1,FieldNum='None',SplitStr='None',FileName='None'):
        ...
        if self.isExistFile(FileName) == False:
            fp = open(FileName, "w", encoding='UTF-8')#https://weirenxue.github.io/2021/06/12/python_cp950_codec_cant_encode/
            # fp.writelines("")
            fp.close()
