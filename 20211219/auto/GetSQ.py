        ...
        try:
            ...
            try:
                sql="insert sq(\
                        ...
                        original_currency_untaxed_amount,untaxed_amount_in_local_currency,\
                        cost_of_goods_sold,gross_profit_margin,invoice_coupon,salesman,\
                        factory_code,library_code,group_name\
                    ) \
                    values('\
                        ...
                        factory_code)+"','"+str(library_code)+"','"+str(group_name)+"'\
...
def main(argv):
    ...
    for k in range(1,res+1):
        ...
        # factory_code)+"','"+str(library_code)+"'\
                    ...
                    insertSqData(RowData[0],RowData[1],RowData[2],RowData[3],RowData[4],RowData[5],RowData[6],RowData[7],RowData[11],RowData[12],RowData[13],RowData[14],RowData[15],RowData[16],RowData[17],RowData[18],RowData[19],RowData[20],str(group))
...
if __name__ == "__main__":
    ...
    if result >= "16:00" and result <= "16:59":
        file_name=str("C:\My Documents\\") + str("COPR23") + str(today.getYear(days=1))+str("1207")+str("000332")+str(today.getYear(days=1))+ str(today.getMonth(days=1))+ str(today.getDay(days=1)).zfill(2)+str("0001.XLSX")
