...
# cost_of_goods_sold, gross_sales, gross_profit_margin
            ...
            try:
                sql="insert ssq(\
                    ...
                    values('\
                        "+(id)+"','"+str(product_id)+"','"+str(store_code)+"','"+checkString(str(product_name))+"','"+str(\
...
#)ENGINE = InnoDB;
                ...
                print("id="+str(RowData[0])+str(store_code))#id=品號+店號
    ...
    # gross_profit_margin varchar(50) character set utf8, #毛利率
        ...
        # factory_code)+"','"+str(library_code)+"'\
                ...
                insertSsqData(RowData[0],RowData[1],RowData[2],RowData[3],RowData[4],RowData[5],RowData[6],RowData[7],RowData[8],RowData[9],RowData[10],RowData[11],RowData[12],RowData[13],RowData[14])
