    ...
    with conn.cursor() as cursor:
        ...
        try:
            ...
            sql="insert sq(\
                    ...
                    cost_of_goods_sold,gross_profit_margin,invoice_coupon,departments,\
...
def main(argv):
    ...
    for k in range(res+1):
        for j in range(5,max_row+1):
            ...
            # time.sleep(2)
            # if ws=wb.sheets[k]
            print("wb.sheets[k] = "+str(wb.sheets[k]))
            print("res = "+str(res))
            print("RowData[0]="+str(RowData[0]))
            print("RowData[1]="+str(RowData[1]))
            print("RowData[2]="+str(RowData[2]))
            print("RowData[3]="+str(RowData[3]))
            print("RowData[4]="+str(RowData[4]))
            print("RowData[5]="+str(RowData[5]))
            print("RowData[6]="+str(RowData[6]))
            print("RowData[7]="+str(RowData[7]))
            print("RowData[8]="+str(RowData[8]))
            print("RowData[9]="+str(RowData[9]))
            print("RowData[10] original_currency_untaxed_amount="+str(RowData[10]))
            print("RowData[11]="+str(RowData[11]))
            print("RowData[12]="+str(RowData[12]))
            print("RowData[13]="+str(RowData[13]))
            print("RowData[14]="+str(RowData[14]))
            print("RowData[15]="+str(RowData[15]))
            print("RowData[16]="+str(RowData[16]))
            print("RowData[17]="+str(RowData[17]))
            print("RowData[18]="+str(RowData[18]))
            print("RowData[19]="+str(RowData[19]))
            print("RowData[20] factory_code="+str(RowData[20]))#library_code
#             "+str(id)+"','"+str(product_name)+"','"+str(customer_code)+"','"+str(sale_date)+"','"+str(sales_number)+"','"+str(\
# sales_quantity)+"','"+str(sales_packaging_quantity)+"','"+str(units)+"','"+str(currencies)+"','"+str(unit_price)+"','"+str(\
# original_currency_untaxed_amount)+"','"+str(untaxed_amount_in_local_currency)+"','"+str(\
# cost_of_goods_sold)+"','"+str(gross_profit_margin)+"','"+str(invoice_coupon)+"','"+str(departments)+"','"+str(\
# factory_code)+"','"+str(library_code)+"'\
            ...
            insertSqData(RowData[0],RowData[1],RowData[2],RowData[3],RowData[4],RowData[5],RowData[6],RowData[7],RowData[8],RowData[9],RowData[10],RowData[11],RowData[12],RowData[13],RowData[14],RowData[15],RowData[16],RowData[17],RowData[18],RowData[19],RowData[20])
        k=k+1
        ws=wb.sheets[k]#翻頁籤
    wb.close()
    app.quit()
