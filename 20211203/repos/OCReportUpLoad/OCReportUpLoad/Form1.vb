...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mydocpath As String = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)
        Dim NowDate As Date = DateTime.Now '.AddDays(-1)
        ...
        report = NowDate.ToString("yyyy") & NowDate.ToString("MM") & "01_" & NowDate.ToString("MMdd") & "網通目標達成比"
        ...
        'setScreenPic(github_report_path, report, 20, 191, 0, 0, 714, 457) '螢幕2 一列24高
        setScreenPic(github_report_path, report, 20, 191, 0, 0, 714, 1 + (Int(args(1)) * 24))
