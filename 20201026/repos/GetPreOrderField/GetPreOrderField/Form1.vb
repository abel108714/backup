...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        setSendTab(1, 5)
        Thread.Sleep(10 * 1000)
        SetCursorPos(619, 198) '619, 198 按視窗
        ...
        'debug += 1
        SetCursorPos(525, 329) '525,329 按進階設定
        'debug += 1
        setMouseClick("left", 2)
        'debug += 1
        SetCursorPos(645, 486) '645,486
        'debug += 1
        setMouseClick("left", 2)
        ...
        Thread.Sleep(10 * 1000)
        SetCursorPos(498, 546) '498,546 按單身
        setMouseClick("left", 2)
        SetCursorPos(645, 486) '645,486
        setMouseClick("left", 2)
        Thread.Sleep(10 * 1000)
        ...
        Thread.Sleep(10 * 1000)
        SetCursorPos(504, 742) '504, 742 按按確定
        setMouseClick("left", 2)
        ...
        '------------------
        Thread.Sleep(10 * 1000)
        SetCursorPos(544, 250) '544, 250 按轉出excel
        setMouseClick("left", 2)
        ...
        If File.Exists(SouPath & Convert.ToString("POSI49_1.XLSX")) Then '如果有預購資料
            ...
            If File.Exists(docpath & Convert.ToString("\DataCt.txt")) Then
                ...
                SetCursorPos(305, 356) '305,356按合計欄位頁籤
                setMouseClick("left", 2)
                Thread.Sleep(2 * 1000)

                SetCursorPos(305, 248) '305,248回第一筆
                setMouseClick("left", 2)
                Thread.Sleep(2 * 1000)
                ...
                For i As Integer = 2 To DataCt '第二筆以(POSTA.TA001 >= N'20200901') And (POSTA.TA001 <= N'20200910')後需要按下一頁
                    ...
                    SetCursorPos(360, 252) '360, 252按下一筆
                    setMouseClick("left", 2)
                    Thread.Sleep(2 * 1000)
                    SetCursorPos(544, 250) '544, 250 按轉出excel
                    setMouseClick("left", 2)
